...
export const da = {
  ...
  push: {
    ...
    newFiles: "{name} lagde {count} filer op",
  ...
  files: {
    ...
    noMatches: "Ingen filer matcher “{query}”.",
    searchPlaceholder: "Søg i denne mappe",
    ...
    attachedFoldersHint:
      "Mapper der hører til en begivenhed eller en forumtråd. De styres derfra og kan ikke flyttes eller omdøbes her.",
    attachedBanner: "Denne mappe hører til {name}.",
    attachedBannerGeneric: "Denne mappe hører til en begivenhed eller en tråd.",
    goToSource: "Gå til den",
    ...
    renameFileTitle: "Omdøb fil",
    fileNamePlaceholder: "Filens navn",
    rename: "Omdøb",
    move: "Flyt",
    download: "Download",
    open: "Åbn",
    ...
    actionsFor: "Handlinger for {name}",

    // Upload
    uploadTitle: "Upload filer",
    uploading: "Uploader…",
    uploadDropHint: "Træk filer hertil, eller",
    uploadChoose: "vælg filer",
    uploadQueueDone: "{count} filer uploadet",
    uploadQueueDoneOne: "1 fil uploadet",
    uploadFailedCount: "{count} fejlede",
    uploadRetry: "Prøv igen",
    uploadCancel: "Afbryd",
    uploadWaiting: "Venter",
    uploadFailed: "Fejlede",
    uploadDone: "Færdig",
    uploadClose: "Luk",
    uploadAddMore: "Tilføj flere",
    ...
    moveToRoot: "Filer (øverste niveau)",
    moveCreateFolder: "Opret ny mappe her",

    // Confirmations
    confirmDeleteTitle: "Slet fil?",
    confirmDelete: "“{name}” slettes permanent. Det kan ikke fortrydes.",
    confirmDeleteManyTitle: "Slet {count} filer?",
    confirmDeleteMany:
      "Filerne slettes permanent. Det kan ikke fortrydes.",
    confirmDeleteFolderTitle: "Slet mappe?",
    confirmDeleteFolder:
      "“{name}” slettes. Indholdet bliver ikke slettet — filer og undermapper flyttes et niveau op.",
    deletedSome: "{count} filer slettet. {skipped} tilhørte andre og blev sprunget over.",

    // Viewer
    viewerClose: "Luk",
    viewerPrev: "Forrige",
    viewerNext: "Næste",
    viewerPosition: "{index} af {total}",
    viewerZoomHint: "Knib for at zoome",
    pdfFallback:
    ...
    kindDOC: "Dokument",
    kindOTHER: "Fil",
    kindWord: "Word-dokument",
    kindExcel: "Regneark",
    kindPowerpoint: "Præsentation",
    kindText: "Tekstfil",
  },
  calendar: {
  ...
  profile: {
    ...
    name: "Navn",
    bio: "Bio",
    avatarTitle: "Profilbillede",
    avatarChange: "Vælg billede",
    avatarRemove: "Fjern billede",
    avatarHint:
      "Billedet beskæres til en cirkel og vises i chatten og på medlemslisten.",
  ...
  chat: {
    ...
    conversationInfo: "Vis medlemmer og indstillinger",
    members: "Medlemmer",
    addMembers: "Tilføj medlemmer",
    removeMember: "Fjern",
    leaveGroup: "Forlad gruppen",
    renameGroup: "Omdøb gruppen",
    newMessagesDivider: "Nye beskeder",
    loadingOlder: "Henter ældre beskeder…",
    sending: "Sender…",
    sendFailed: "Kunne ikke sendes.",
    retry: "Prøv igen",
    discard: "Kassér",
    jumpToLatest: "Til seneste",
    reply: "Svar",
    replyingTo: "Svarer {name}",
    edit: "Rediger",
    editing: "Redigerer besked",
    edited: "(redigeret)",
    delete: "Slet",
    deleteConfirm: "Slet — er du sikker?",
  ...
  errors: {
    ...
    nothingSelected: "Vælg mindst én fil.",
    invalidFolderName: "Giv mappen et navn (højst 100 tegn).",
    invalidFileName: "Giv filen et navn (højst 200 tegn).",
    folderLoop: "En mappe kan ikke flyttes ind i sig selv.",
    folderTooDeep: "Mapperne kan højst ligge {count} niveauer dybt.",
    ...
    avatarInvalid: "Billedet kunne ikke bruges — vælg en almindelig billedfil.",
    avatarTooLarge: "Billedet er for stort (maks. 15 MB).",
    groupNameRequired: "Giv gruppen et navn.",
    membersRequired: "Vælg mindst ét medlem.",
    notGroupAdmin: "Kun gruppens administrator kan gøre det.",
    messageNotEditable: "Beskeden kan ikke redigeres.",
